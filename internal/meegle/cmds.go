...
func FetchTasksCmd(client Client, reqID int) tea.Cmd {
	return func() tea.Msg {
		...
		return TasksFetchedMsg{ReqID: reqID, Tasks: tasks, Err: err}
	}
}
...
func CreateTaskCmd(client Client, reqID int, name string) tea.Cmd {
	return func() tea.Msg {
		...
		return TaskCreatedMsg{ReqID: reqID, Task: task, Err: err}
	}
}
...
func CreateSubTaskCmd(client Client, reqID int, taskID, name string) tea.Cmd {
	return func() tea.Msg {
		...
		return SubTaskCreatedMsg{ReqID: reqID, TaskID: taskID, SubTask: sub, Err: err}
	}
}
...
func ToggleSubTaskDoneCmd(client Client, reqID int, taskID, subTaskID string, done bool) tea.Cmd {
	return func() tea.Msg {
		...
		return SubTaskToggledMsg{ReqID: reqID, TaskID: taskID, SubTask: sub, Err: err}
	}
}
